...
var Lib={JQueryUI:function(a){Load.JS(jQueryUI,true,a)
},JQueryTmpl:function(a){Load.JS(jQueryTmpl,true,a)
},JQueryCycle:function(a){Load.JS(jQueryCycle,true,a)
},JQueryValidate:function(a){Load.JS(jQueryValidate,true,a)
},JQueryDataTable:function(a){Load.JS(jQueryDataTables,true,a)
},JQueryMobile:function(a){Load.JS(jQueryMobile,true,a)
},SWFObject:function(a){Load.JS(swfObject,true,a)
},Ajax:function(a){Load.JS(ajax,true,a)
},MobileDetect:function(a){Load.JS(mobile,true,a)
},Tooltip:function(a){Load.JS(tooltip,true,a)
},Utils:function(a){Load.JS(utils,true,a)
},NavEngine:function(a){Load.JS(navEngine,true,a)
},JQueryNailThumb:function(a){Load.JS(jQueryNailThumb,true,function(){Load.JS(jQueryImgPreloader,true,a)
})
}};